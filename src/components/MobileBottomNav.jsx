    ...
    <nav className='fixed inset-x-0 bottom-0 md:hidden' style={{zIndex: 9999}}>
      <div className='w-full bg-orange-600 border-t border-orange-700 shadow-2xl' style={{paddingBottom: 'env(safe-area-inset-bottom)'}}>
        ...
        <div className='max-w-[900px] mx-auto flex justify-between items-center h-18 px-4' style={{height: '68px'}}>
          ...
          <Link to='/collection' aria-label='Categories' className='flex flex-col items-center text-white text-xs'>
          ...
          <Link to='/artisans' aria-label='Live' className='flex flex-col items-center text-white text-xs'>
          ...
          <Link to='/notifications' aria-label='Notifications' className='flex flex-col items-center text-white text-xs'>
          ...
          <Link to='/profile' aria-label='Profile' className='flex flex-col items-center text-white text-xs'>
